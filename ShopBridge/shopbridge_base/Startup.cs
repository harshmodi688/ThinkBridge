    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Shopbridge_base",
                    Version = "v1"
                });
            });
            //services.AddApiVersioning(services => services.ApiVersionReader = new HeaderApiVersionReader("api-version"));
            ...
            services.AddShoppingBridgeCore(options => options.UseInMemoryDatabase("Shopbridge_Context"));
